...
function fetchRecord() {
    ...
    if (PatientID != -1) {
        ...
        xhr.open("POST", "scripts/fetch_visit.php", true);
...
<body>
	...
	<nav>
		...
		<li><a href="#" style="color: #f3e393;">Visits</a></li><li class="spacer">|</li>
	...
	<div class="scrollable"> 
		...
		<thead> 
			<tr height='30'> 
				...
				<td width='10%'><b>Case Fee Type</b></td> 
				<td width='15%'><b>Visit Category</b></td> 
